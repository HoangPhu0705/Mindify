...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Enrollment and Revenue Charts')),
                    ...
                    AspectRatio(
                      ...
                      child: DChartBarT(
                        ...
                        domainAxis: DomainAxis(
                          labelFormatterT: (time) => DateFormat('MM-yyyy').format(time),
                          showLine: true,
                        ),
                        ...
                        barLabelValue: (group, datum, index) => datum.measure.toString(),
